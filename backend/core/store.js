...
function createDefaultStore() {
  ...
  return {
    ...
    sessions: [],
    machines: [
      { id: 1,  siteId: "SITE-01", siteName: "Honda R&D Offenbach - H2",  machineCode: "SRV-A",  machineName: "Serveur Rack A",        machineType: "server",     isActive: true },
      { id: 2,  siteId: "SITE-01", siteName: "Honda R&D Offenbach - H2",  machineCode: "SRV-B",  machineName: "Serveur Rack B",        machineType: "server",     isActive: true },
      { id: 3,  siteId: "SITE-01", siteName: "Honda R&D Offenbach - H2",  machineCode: "SRV-C",  machineName: "Serveur Rack C",        machineType: "server",     isActive: true },
      { id: 4,  siteId: "SITE-01", siteName: "Honda R&D Offenbach - H2",  machineCode: "ECL-H2", machineName: "Eclairage Bureau H2",   machineType: "lighting",   isActive: true },
      { id: 5,  siteId: "SITE-02", siteName: "Honda R&D Offenbach - H4",  machineCode: "ECL-H4", machineName: "Eclairage Bureau H4",   machineType: "lighting",   isActive: true },
      { id: 6,  siteId: "SITE-03", siteName: "Honda R&D Offenbach - H1",  machineCode: "LAB-EM", machineName: "Atelier Emission Lab",  machineType: "test_bench", isActive: true },
      { id: 7,  siteId: "SITE-01", siteName: "Honda R&D Offenbach - H2",  machineCode: "ATL-MC", machineName: "Atelier Mecanique",     machineType: "workshop",   isActive: true },
      { id: 8,  siteId: "SITE-01", siteName: "Honda R&D Offenbach - H2",  machineCode: "DSN-ST", machineName: "Design Studio",         machineType: "studio",     isActive: true },
      { id: 9,  siteId: "SITE-01", siteName: "Honda R&D Offenbach - H2",  machineCode: "VNT-H2", machineName: "Ventilation CTA H2",    machineType: "hvac",       isActive: true },
      { id: 10, siteId: "SITE-02", siteName: "Honda R&D Offenbach - H4",  machineCode: "VNT-H3", machineName: "Ventilation CTA H3",    machineType: "hvac",       isActive: true },
      { id: 11, siteId: "SITE-03", siteName: "Honda R&D Offenbach - H1",  machineCode: "PV-TOI", machineName: "Panneaux PV Toiture",   machineType: "pv_panel",   isActive: true },
      { id: 12, siteId: "SITE-03", siteName: "Honda R&D Offenbach - H1",  machineCode: "CHP-EL", machineName: "Cogeration CHP Elec",   machineType: "chp_unit",   isActive: true },
      { id: 13, siteId: "SITE-01", siteName: "Honda R&D Offenbach - H2",  machineCode: "GF-PRI", machineName: "Groupe Froid Principal", machineType: "chiller",    isActive: true },
      { id: 14, siteId: "SITE-01", siteName: "Honda R&D Offenbach - H2",  machineCode: "GF-SEC", machineName: "Groupe Froid Secours",  machineType: "chiller",    isActive: true },
      { id: 15, siteId: "SITE-03", siteName: "Honda R&D Offenbach - H1",  machineCode: "CHP-TH", machineName: "Chauffage CHP Therm",   machineType: "boiler",     isActive: true },
    ],
    alerts: [
    ...
    machineLive: [
      { id: 1,  machineId: 1,  powerKw: 17.2,  enpi: 2.08, loadPct: 78, status: "running",  updatedAt: nowIso() },
      { id: 2,  machineId: 2,  powerKw: 14.3,  enpi: 2.14, loadPct: 72, status: "running",  updatedAt: nowIso() },
      { id: 3,  machineId: 3,  powerKw: 11.5,  enpi: 1.96, loadPct: 68, status: "running",  updatedAt: nowIso() },
      { id: 4,  machineId: 4,  powerKw: 7.2,   enpi: 1.82, loadPct: 54, status: "running",  updatedAt: nowIso() },
      { id: 5,  machineId: 5,  powerKw: 5.7,   enpi: 1.78, loadPct: 48, status: "running",  updatedAt: nowIso() },
      { id: 6,  machineId: 6,  powerKw: 21.5,  enpi: 2.32, loadPct: 85, status: "running",  updatedAt: nowIso() },
      { id: 7,  machineId: 7,  powerKw: 11.5,  enpi: 2.18, loadPct: 74, status: "running",  updatedAt: nowIso() },
      { id: 8,  machineId: 8,  powerKw: 8.6,   enpi: 1.90, loadPct: 62, status: "running",  updatedAt: nowIso() },
      { id: 9,  machineId: 9,  powerKw: 10.0,  enpi: 2.04, loadPct: 70, status: "running",  updatedAt: nowIso() },
      { id: 10, machineId: 10, powerKw: 7.2,   enpi: 1.92, loadPct: 58, status: "running",  updatedAt: nowIso() },
      { id: 11, machineId: 11, powerKw: 74.8,  enpi: 0.85, loadPct: 92, status: "running",  updatedAt: nowIso() },
      { id: 12, machineId: 12, powerKw: 70.5,  enpi: 1.12, loadPct: 88, status: "running",  updatedAt: nowIso() },
      { id: 13, machineId: 13, powerKw: 9.7,   enpi: 2.22, loadPct: 76, status: "running",  updatedAt: nowIso() },
      { id: 14, machineId: 14, powerKw: 5.2,   enpi: 2.06, loadPct: 52, status: "idle",     updatedAt: nowIso() },
      { id: 15, machineId: 15, powerKw: 116.0, enpi: 1.48, loadPct: 94, status: "running",  updatedAt: nowIso() },
    ],
    anomalies: [
      {
        id: 1,
    ...
    energyTimeline: [
      ...buildTimelineSeries(1, 2.02, 17),
      ...buildTimelineSeries(2, 2.08, 14),
      ...buildTimelineSeries(3, 1.94, 12),
      ...buildTimelineSeries(4, 1.78, 7),
      ...buildTimelineSeries(5, 1.74, 6),
      ...buildTimelineSeries(6, 2.28, 22),
      ...buildTimelineSeries(7, 2.12, 12),
      ...buildTimelineSeries(8, 1.86, 9),
      ...buildTimelineSeries(9, 2.00, 10),
      ...buildTimelineSeries(10, 1.88, 7),
      ...buildTimelineSeries(11, 0.82, 75),
      ...buildTimelineSeries(12, 1.08, 71),
      ...buildTimelineSeries(13, 2.18, 10),
      ...buildTimelineSeries(14, 2.02, 5),
      ...buildTimelineSeries(15, 1.44, 116),
    ],
